...
const Tentang = () => {
  ...
  return (
    <>
      <Header type="title" text="Syarat dan Ketentuan" />
      <div className="content-wrapper bg-grey">
        <div className="container">
          <div className="box-content relative-top">
            <div className="flex flex-col items-center justify-center pt-[65px]">
              <h5>Syarat & Ketentuan</h5>
              <h2 className="text-green m-0 font-bold">
              ...
              {isOpen[1] && (
                <>
                  <p className="text-justify">
                    <span className="font-bold">AksiBerbagi.com </span>{' '}
                    Merupakan website dana atau aplikasi Donasi dan Penggalangan
                    Dana secara Online. Melalui AksiBerbagi.com siapapun dapat
                    berperan untuk mewujudkan kebaikan Bersama-sama.
                  </p>
                  <p className="text-justify">
                    Sebagai bentuk menjaga orisinalitas, kebenaran / validitas
                    konten dan juga kemanan dari setiap kampanye yang diajukan
                    oleh Inisiator Kebaikan, maka Management AksiBerbagi.com
                    mengeluarkan Ketentuan Umum dan Khusus terkait dengan
                    Program yang dibuat oleh pihak Inisiator Kebaikan untuk di
                    Release di website AksiBerbagi.com.
                  </p>
                </>
              )}
              <br />
