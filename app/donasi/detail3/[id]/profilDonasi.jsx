    ...
    <>
      <div className="donate-detail-header mb-4">
        <div className="donate-profile !pb-0 ">
          ...
          {salur && (
            <div className="flex justify-between items-center">
              ...
              <Link
                ...
                className="underline text-gray-500 cursor-pointer text-sm md:text-base"
              >
                Lihat Selengkapnya
              </Link>
            </div>
          ...
          <div className="donate-profile-box !mb-0 bg-secondary-500 !rounded-t-lg !rounded-b-none">
            <div className="flex flex-col md:flex-row gap-2 items-center justify-between">
              <div className="flex items-center justify-center gap-2 flex-col min-w-[200px]">
                <div className="bg-cyan-100 px-4 flex gap-2 py-2 rounded-md text-base md:text-lg font-bold text-cyan-900">
              ...
              <div className="flex gap-2 flex-col text-white">
                ...
                <div className="justify-center md:justify-start flex items-center underline text-white cursor-pointer gap-2 text-base md:text-lg font-medium">
                  <FaWhatsapp size={20} />
                  +62 8191-2344-745
                </div>
                <div> Senin - Jumat, 08.00 sd 16.00</div>
              </div>
            </div>
          </div>
          <div
